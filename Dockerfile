...
RUN	cd /mera; wget http://mera400.pl/img/bootw.bin; wget http://mera400.pl/img/crook5-p8f-1.0.0.zip
RUN	cd /mera; unzip crook5-p8f-1.0.0.zip; rm crook5-p8f-1.0.0.zip
